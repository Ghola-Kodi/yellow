    ...
    <main className="min-h-screen bg-slate-950 px-4 py-12 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-6 lg:max-w-xl">
          ...
          <div>
            <h1 className="text-4xl font-semibold text-white sm:text-5xl">Create your account</h1>
            <p className="mt-4 max-w-xl text-base leading-7 text-slate-400">
              Sign up with Google or use the demo credentials to preview the full dunning dashboard.
            </p>
          </div>
          <div className="grid gap-4 rounded-3xl border border-slate-800 bg-slate-900/80 p-6 shadow-lg shadow-black/20">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm text-slate-400">Demo signup values</p>
                <p className="text-sm font-semibold text-white">admin@admin.cpm / admin123</p>
              </div>
              <Badge variant="success">Instant access</Badge>
            </div>
            <p className="text-sm text-slate-500">Use the demo credentials while your Supabase project is being configured.</p>
          </div>
        </div>
        ...
        <Card className="w-full max-w-xl p-8">
          <div className="space-y-4">
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-slate-500">Get started</p>
              <h2 className="mt-3 text-2xl font-semibold text-white">Sign up for free</h2>
            </div>
            ...
            <p className="text-center text-sm text-slate-400">
              ...
              <Link href="/login" className="font-semibold text-white hover:text-slate-100">
                Sign in
              </Link>
            </p>
          </div>
